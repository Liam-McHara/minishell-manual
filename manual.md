...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="https://github.com/Liam-McHara/minishell-manual/blob/main/assets/minish_loop_dark.png?raw=true">
  <source media="(prefers-color-scheme: light)" srcset="https://github.com/Liam-McHara/minishell-manual/blob/main/assets/minish_loop_light.png?raw=true">
  <img alt="minish title" src="https://github.com/Liam-McHara/minishell-manual/blob/main/assets/minish_loop_light.png?raw=true">
</picture>
...
[^pipe]: <ins>**pipe**</ins>: A token that separates one command from the next, connecting the output of the former to the output of the latter. It can be also considered a _redirection operator_. It is `|`.
